...
|------------|-----------|-------------|
| **base** | Always after sphere_overview | 71 tools: navigation, geometry, basic analysis |
...
| **Tool Annotations** | `readOnlyHint=True` on 71 read-only tools | Host assumes worst case |
